...
<form action="{{route('staff.update',$staff->id)}}" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group my-3">
        ...
        <input value="{{$staff->name}}" required name="staff_name" type="text" class="form-control" id="name"
    ...
    <div class="form-group my-3">
        ...
        <input required value="{{$staff->address}}" name="staff_address" type="text" class="form-control"
    ...
    <div class="form-group my-3">
        ...
        <input value="{{$staff->phone}}" required name="staff_phone" type="number" class="form-control"
    ...
    <div class="form-group my-3">
        ...
        <input value="{{$staff->mail}}" required name="staff_mail" type="email" class="form-control"
