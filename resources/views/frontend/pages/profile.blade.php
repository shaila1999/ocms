            ...
            <div class="col-md-8 border-right">
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-12"><label class="labels">Address </label><input name="user_address" type="text" class="form-control" placeholder="enter address " value="{{auth()->user()->address}}"></div>
                        <div class="col-md-12">

                        <div class="form-group">
                            <label for="">Select type</label>
                            <select name="role" id="" class="form-control">
                                <option value="parent" {{(auth()->user()->role=='parent')?'selected':''}}>Parent</option>
                                <option value="donor" {{(auth()->user()->role=='donor')?'selected':''}}>Donor</option>
                            </select>
                        </div>
                        </div>
